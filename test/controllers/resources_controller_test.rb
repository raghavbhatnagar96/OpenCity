...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { date_published: @resource.date_published, description: @resource.description } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { date_published: @resource.date_published, description: @resource.description } }
